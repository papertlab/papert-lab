...
from papertlab.urls import github_issues
...
def report_github_issue(issue_text, title=None):
    ...
    :return: None
    """
    version_info = f"Papertlab version: {__version__}\n"
    ...
    print()
    print("Please consider reporting this bug to help improve papertlab!")
