...
def get_parser(default_config_files, git_root):
    class SilentParser(configargparse.ArgumentParser):
        def error(self, message):
            sys.stderr.write(f'papertlab: error: {message}\n')
            sys.exit(2)
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'papertlab: ' if papertlab authored the changes (default: False)",
    )
    group.add_argument(
